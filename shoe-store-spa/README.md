...
- Integrate DummyJSON product API with strict TypeScript interfaces.
- Add search/filtering.
- Add detail view (route/modal).
- Add one bonus feature for A/A+ target (Pinia cart or dynamic route).
